...
## 1. Exact conventional-level guarantees now include n = 6 at 95%
...
At **95% nominal confidence**, a larger five-dimensional certificate extends
the same pointwise comparison to **n = 6**. Generic exact face-ideal checks
establish the structural zeros. Directed dyadic interval arithmetic verifies
their full-rank specialization, the region triangulation, and every remaining
Bernstein sign
([n = 6 proof](supporting-materials/theory/N6-CONVENTIONAL.md)). The 90% and
99% cases at n = 6 are not claimed.
...
theorem at n = 2,
this makes **n = 6 the first unresolved sample size at 90% and 99%**, and
**n = 7 the first unresolved sample size at 95%**.

This is a meaningful finite-sample advance, but n = 6 is far smaller than an
...
n = 3, 4, and 5 at 90%, 95%, and 99%, and at n = 6 and 95%. A new one-cap theorem gives a much
...
first open case is n = 6 at 90% and 99%, and n = 7 at 95%; coverage for the
...
three levels above; n = 6 at 95%; populations supported on {0,1}; and populations with one
nonzero taint value
...
exhaustive proof. The exact n = 2 through n = 5 results, and the n = 6
result at 95%, do not
...
The n = 3 through n = 6 proofs use a different, geometric route. The one-cap
theorem now controls one complete geometric region at every sample size for
nominal confidence of at least 75%.
Determining whether the n = 6 certificate extends to 90% and 99%, whether
the 95% result extends to n = 7, and whether the cap inequalities admit a
