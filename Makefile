...
.PHONY: sync test proof-check all-n-reduction-check dirichlet-poissonization-check poisson-band-certificate-check n3-formula-check n3-certificate-check n4-structure-check n4-certificate-check n5-structure-check n5-certificate-check certificate-summary-check claim-manifest-check paper reproduce
...
reproduce: sync test proof-check all-n-reduction-check dirichlet-poissonization-check poisson-band-certificate-check n3-formula-check n3-certificate-check n4-structure-check n4-certificate-check n5-structure-check n5-certificate-check certificate-summary-check claim-manifest-check paper
	@echo "Core proofs, all-n reductions, Dirichlet-Poissonization research certificate, Poisson simultaneous-band certificate, n=3 through n=5 Bernstein certificates, counterexample summaries, claim links, tests, and manuscript build passed."
