...
.PHONY: sync test proof-check n3-formula-check n3-certificate-check n4-structure-check n4-certificate-check certificate-summary-check claim-manifest-check paper reproduce
...
reproduce: sync test proof-check n3-formula-check n3-certificate-check n4-structure-check n4-certificate-check certificate-summary-check claim-manifest-check paper
	@echo "Core proofs, n=3 and n=4 Bernstein certificates, counterexample summaries, claim links, tests, and manuscript build passed."
