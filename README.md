...
of 1.525906, 1.436135, and 1.320081 at 90%, 95%, and 99%, respectively. More
generally,
...
- **All-sample-size scalar calibration of the Poisson bound**
  ...
  \(2/e\approx73.6\%\). Retaining the first 200 Poisson crossing
  probabilities and bounding the remainder geometrically reduces the
  uniform choices to 1.525906, 1.436135, and 1.320081 at 90%, 95%, and 99%,
  respectively.
...
which now also proves the complete threshold comparison for $n=2,3,4$,
every $n=5$ profile with at most four nonzero coordinates, every profile
having three nonzero coefficients in every dimension, and a sparse
...
that comparison is now $n=5$, where only the five-positive boundary remains;
