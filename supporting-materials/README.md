...
it is also proved on the equal-smaller symmetry line.  Its off-symmetry
strict interior remains open.
...
| `all_n_poisson_reductions.py` | Symbolic and exact-rational checks of the ordered-weight identity, the exact two-exponential theorem, the equal-weight Hessian, the three-weight reduction and its two proved symmetry families, and the open-route kernel identity | proof support |
