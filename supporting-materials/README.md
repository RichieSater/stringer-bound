...
coefficients, for dimension-free convex-core and far-cap regions with three
nonzero coefficients, and completely for `n=2` and `n=3`.  The program note
