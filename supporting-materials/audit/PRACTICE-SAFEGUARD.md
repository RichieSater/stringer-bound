...
At `n=3,4,5,6` and 90%, 95%, and 99% confidence, exact pointwise theorems in
...
exact pointwise comparison beyond the current `n=6` frontier, or finding a dimension-free
