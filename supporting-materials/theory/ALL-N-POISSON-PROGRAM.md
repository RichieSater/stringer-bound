...
`c>=n-1` and the full middle-knot region `b<=n/3`.  A derivative comparison,
analytic tail bounds, and a rigorous finite-prefix interval certificate then
complete the entire three-positive face.
